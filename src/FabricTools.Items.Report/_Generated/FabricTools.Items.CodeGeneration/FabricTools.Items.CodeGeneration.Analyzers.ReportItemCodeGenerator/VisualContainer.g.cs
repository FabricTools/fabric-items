...
public partial class VisualContainer
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonProperty("visual", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    public VisualConfiguration? Visual { get; set; } = default!;

    /// <summary>
    /// Defines that this container should be used as a grouping container.
    /// </summary>
    [Newtonsoft.Json.JsonProperty("visualGroup", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    /// </summary>
    [Newtonsoft.Json.JsonProperty("parentGroupName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
